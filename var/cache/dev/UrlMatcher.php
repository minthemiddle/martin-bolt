...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .')'
                .'|/thumbs/([^/]++)/(.+)(*:815)'
                .'|/((?:rss|atom|json))/feed\\.((?:rss|atom|json|xml))(*:873)'
                .'|/((?:rss|atom|json))/([^/]++)/feed\\.((?:rss|atom|json|xml))(*:940)'
                .'|/bolt/_trans(?'
                    .'|(?:/([^/]++))?(*:977)'
                    .'|/([^/]++)/([^/]++)/([^/]++)(?'
                        .'|(*:1015)'
                ...
                .'|/_(?'
                    ...
                    .')'
                .')'
                .'|/(homepage|pages|articles|blocks|page|article|block)/([^/]++)(*:1371)'
                .'|/(en|nl|es|fr|de|pl|it|hu|pt_BR|ja|nb|nn|nl_NL|nl_BE|is|ru)/(homepage|pages|articles|blocks|page|article|block)/([^/]++)(*:1500)'
                .'|/(en|nl|es|fr|de|pl|it|hu|pt_BR|ja|nb|nn|nl_NL|nl_BE|is|ru)(*:1568)'
                .'|/(homepage|pages|articles|blocks|page|article|block)(*:1629)'
                .'|/(en|nl|es|fr|de|pl|it|hu|pt_BR|ja|nb|nn|nl_NL|nl_BE|is|ru)/(homepage|pages|articles|blocks|page|article|block)(*:1749)'
                .'|/([^/]++)/search(*:1774)'
                .'|/(tags|groups|categories|tag|group|category)/([^/]++)(*:1836)'
                .'|/(en|nl|es|fr|de|pl|it|hu|pt_BR|ja|nb|nn|nl_NL|nl_BE|is|ru)/(tags|groups|categories|tag|group|category)/([^/]++)(*:1957)'
            .')/?$}sD',
    ],
    [ // $dynamicRoutes
        ...
        210 => [[['_route' => 'api_fields_get_collection', '_controller' => 'api_platform.action.get_collection', '_format' => null, '_api_resource_class' => 'Bolt\\Entity\\Field', '_api_collection_operation_name' => 'get'], ['_format'], ['GET' => 0], null, false, true, null]],
        244 => [[['_route' => 'api_fields_get_item', '_controller' => 'api_platform.action.get_item', '_format' => null, '_api_resource_class' => 'Bolt\\Entity\\Field', '_api_item_operation_name' => 'get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        280 => [[['_route' => 'api_relations_get_collection', '_controller' => 'api_platform.action.get_collection', '_format' => null, '_api_resource_class' => 'Bolt\\Entity\\Relation', '_api_collection_operation_name' => 'get'], ['_format'], ['GET' => 0], null, false, true, null]],
        314 => [[['_route' => 'api_relations_get_item', '_controller' => 'api_platform.action.get_item', '_format' => null, '_api_resource_class' => 'Bolt\\Entity\\Relation', '_api_item_operation_name' => 'get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        ...
        815 => [[['_route' => 'thumbnail', '_controller' => 'Bolt\\Controller\\ImageController::thumbnail'], ['paramString', 'filename'], ['GET' => 0], null, false, true, null]],
        873 => [[['_route' => 'rss_extension', '_controller' => 'Bobdenotter\\RssExtension\\Controller::feed'], ['type', 'extension'], null, null, false, true, null]],
        940 => [[['_route' => 'rss_extension_single', '_controller' => 'Bobdenotter\\RssExtension\\Controller::feedSingle'], ['type', 'contenttype', 'extension'], null, null, false, true, null]],
        977 => [[['_route' => 'translation_index', '_controller' => 'Translation\\Bundle\\Controller\\WebUIController::indexAction', 'configName' => null], ['configName'], ['GET' => 0], null, false, true, null]],
        1015 => [[['_route' => 'translation_show', '_controller' => 'Translation\\Bundle\\Controller\\WebUIController::showAction'], ['configName', 'locale', 'domain'], ['GET' => 0], null, false, true, null]],
        1028 => [[['_route' => 'translation_create', '_controller' => 'Translation\\Bundle\\Controller\\WebUIController::createAction'], ['configName', 'locale', 'domain'], ['POST' => 0], null, false, false, null]],
        1037 => [
        ...
        1077 => [[['_route' => 'php_translation_profiler_translation_edit', '_controller' => 'Translation\\Bundle\\Controller\\SymfonyProfilerController::editAction'], ['token'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1093 => [[['_route' => 'php_translation_profiler_translation_sync', '_controller' => 'Translation\\Bundle\\Controller\\SymfonyProfilerController::syncAction'], ['token'], ['POST' => 0], null, false, false, null]],
        1106 => [[['_route' => 'php_translation_profiler_translation_sync_all', '_controller' => 'Translation\\Bundle\\Controller\\SymfonyProfilerController::syncAllAction'], ['token'], ['POST' => 0], null, false, false, null]],
        1129 => [[['_route' => 'php_translation_profiler_translation_create_assets', '_controller' => 'Translation\\Bundle\\Controller\\SymfonyProfilerController::createAssetsAction'], ['token'], ['POST' => 0], null, false, false, null]],
        1170 => [[['_route' => '_twig_error_test', '_controller' => 'twig.controller.preview_error::previewErrorPageAction', '_format' => 'html'], ['code', '_format'], null, null, false, true, null]],
        1191 => [[['_route' => '_wdt', '_controller' => 'web_profiler.controller.profiler::toolbarAction'], ['token'], null, null, false, true, null]],
        1238 => [[['_route' => '_profiler_search_results', '_controller' => 'web_profiler.controller.profiler::searchResultsAction'], ['token'], null, null, false, false, null]],
        1253 => [[['_route' => '_profiler_router', '_controller' => 'web_profiler.controller.router::panelAction'], ['token'], null, null, false, false, null]],
        1274 => [[['_route' => '_profiler_exception', '_controller' => 'web_profiler.controller.exception_panel::body'], ['token'], null, null, false, false, null]],
        1288 => [[['_route' => '_profiler_exception_css', '_controller' => 'web_profiler.controller.exception_panel::stylesheet'], ['token'], null, null, false, false, null]],
        1299 => [[['_route' => '_profiler', '_controller' => 'web_profiler.controller.profiler::panelAction'], ['token'], null, null, false, true, null]],
        1371 => [[['_route' => 'record', 'contentTypeSlug' => null, '_controller' => 'Bolt\\Controller\\Frontend\\DetailController::record'], ['contentTypeSlug', 'slugOrId'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1500 => [[['_route' => 'record_locale', 'contentTypeSlug' => null, '_controller' => 'Bolt\\Controller\\Frontend\\DetailController::record'], ['_locale', 'contentTypeSlug', 'slugOrId'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1568 => [[['_route' => 'homepage_locale', '_controller' => 'Bolt\\Controller\\Frontend\\HomepageController::homepage'], ['_locale'], ['GET' => 0, 'POST' => 1], null, true, true, null]],
        1629 => [[['_route' => 'listing', '_controller' => 'Bolt\\Controller\\Frontend\\ListingController::listing'], ['contentTypeSlug'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1749 => [[['_route' => 'listing_locale', '_controller' => 'Bolt\\Controller\\Frontend\\ListingController::listing'], ['_locale', 'contentTypeSlug'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1774 => [[['_route' => 'search_locale', '_controller' => 'Bolt\\Controller\\Frontend\\SearchController::search'], ['_locale'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1836 => [[['_route' => 'taxonomy', '_controller' => 'Bolt\\Controller\\Frontend\\TaxonomyController::listing'], ['taxonomyslug', 'slug'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1957 => [
